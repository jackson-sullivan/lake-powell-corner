...
<template>
  <header
    :class="
      isHome
        ? 'absolute inset-x-0 top-0 z-30 bg-transparent text-white border-0'
        : 'border-0 backdrop-blur bg-white/70 text-[var(--color-accent-ink,#1f2937)]'
    "
  >
    <div
      :class="
        isHome
          ? 'flex items-center justify-start px-4 py-3 md:px-6 w-full'
          : 'flex items-center justify-center px-4 py-3 md:px-6 mx-auto max-w-5xl'
      "
    >
      <RouterLink
        to="/"
